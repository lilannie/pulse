...
const createCitizen = async (citizen_model, citizen) =>
  await fetch('http://localhost:3333/create/user', {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json'
    }
...
const createVote = async vote =>
  await fetch('http://localhost:3333/contract/vote', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
